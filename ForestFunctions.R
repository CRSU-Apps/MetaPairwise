### Forest command from metafor package - adjusted to include both random and fixed effects models if wanted (by adding extra model as y) ###
forest.rma.CN <- function(x, y,                              # y is the other model if want to show fixed and random effects estimates
