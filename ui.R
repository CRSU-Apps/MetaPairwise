...
shinyUI(
  ...
  navbarPage(id="MetaPairwise",
             ...
             tabPanel("Data",
                      ...
                      column(4, h4("View Data"), uiOutput("data")),
             ...
             tabPanel("Calculator",
                      ...
                      sidebarLayout(
                        ...
                        sidebarPanel(h4("Synthesis Options"),
                                     ...
                                     conditionalPanel(condition= "input.AnalysisType=='Bayesian Analysis'",
                                                      h5("Bayesian Options"),
                                                      fluidRow(column(6, radioButtons("prior", "Vague prior for between study standard deviation:", c("Half-Cauchy(0,0.5)" = "half-cauchy", "Uniform(0,2)" = "uniform", "Half-Normal(0,1)" = "half-normal")),
