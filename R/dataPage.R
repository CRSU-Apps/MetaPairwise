dataPageUI <- function(id) {
  ...
  div(
   column(4, h4("Choose Data"),                    # Insert own data or choose example data
          ...
          fileInput(inputId=ns("data"), label="", buttonLabel="Select", placeholder="No file selected"),
          br(),
          ...
          radioButtons(ns("ChooseExample"), "Example Datasets Available", c("Continuous outcome: Change in VA in terms of LogMAR (negative change in LogMAR = improved vision)" = "continuousEx",
   ...
   column(4, h4("View Data"), uiOutput(ns("data"))),
