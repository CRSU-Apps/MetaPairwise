...
BinaryInstructionsPanelUi <- function(id) {
  ...
  div(
    p("MetaPairwise can take data in wide format (one row per study) or long format (one row per study arm)."),
    p("The data file should contain five or eight columns for long or wide format respectively. Headings of columns are case sensitive."),
